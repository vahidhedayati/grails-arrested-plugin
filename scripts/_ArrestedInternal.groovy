...
target(updateResources: "Update the application resources") {
    ...
    configFile.withWriterAppend { BufferedWriter writer ->
        ...
        writer.writeLine "        resource url:'http://code.angularjs.org/1.2.11/angular-resource.min.js'"
        writer.writeLine "    }"
        writer.writeLine ""
        writer.writeLine "    angular {"
        writer.writeLine "        dependsOn 'jQuery'"
        writer.writeLine "        resource url:'http://code.angularjs.org/1.2.11/angular.min.js'"
        writer.writeLine "    }"
        writer.writeLine ""
